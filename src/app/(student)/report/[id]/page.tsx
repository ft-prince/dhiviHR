    ...
    <>
      ...
      <main className="container-narrow py-12">
        <div className="flex items-center justify-between">
          <h1 className="display-headline text-4xl">Your Readiness Report</h1>
          <Link href="/dashboard"><Button variant="ghost">Back to dashboard</Button></Link>
        </div>

        {!paid ? (
          <div className="mt-10 grid md:grid-cols-2 gap-8">
            <div className="rounded-2xl bg-brand-50 border border-brand-100 p-8 relative overflow-hidden">
              ...
              <div className="mt-1 display-headline text-5xl text-brand-600">██ / 100</div>
            </div>
    ...
    <div className="mt-10">
      <div className="grid md:grid-cols-3 gap-5">
        <div className="md:col-span-2 rounded-2xl border border-border bg-white p-8 shadow-soft">
          ...
          <div className="mt-2 display-headline text-6xl text-brand-600">{total} <span className="text-ink-soft text-3xl">/ 100</span></div>
      ...
      <div className="mt-8 rounded-2xl border border-border bg-white p-8">
        <h2 className="display-headline text-2xl">Competency Breakdown</h2>
